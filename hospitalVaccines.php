...
if (isset($_SESSION['userID'])) {
    ...
    $queryHospital = $pdo->prepare("SELECT u.name AS hospital_name, v.id AS vaccine_id, v.name AS vaccine_name, v.availability, v.manufacturer, v.Vaccination_age
                                    FROM hospitals h
    ...
    if (!empty($hospitalData)) {
        ...
        <div class="content-wrapper">
            <div class="container-xxl flex-grow-1 container-p-y">
                ...
                <a href="addVaccine.php" class="btn btn-primary">Add More Vaccine</a>
                <div class="card">
        ...
        echo '<script>alert("No data found for the logged-in hospital.");</script>';
    }
}
