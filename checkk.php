...
if (isset($_SESSION['userID'])) {
                            ...
                            foreach ($allChildren as $child) {
                                ...
                                foreach ($allVaccines as $vaccine) {
                                    ...
                                    if (!empty($matches)) {
                                        ...
                                        // Check if the child has already been vaccinated for the current vaccine
                                        ...
                                        if ($vaccinationDate > $currentDate && $existingVaccinationQuery->rowCount() == 0) {
                                            // Child has not been vaccinated, display the upcoming vaccination date
                                            echo "<tr>";
                                            echo "<td>" . $child['id'] . "</td>";
    ...
    if (isset($_POST['submitAppointment'])) {
        ...
        alert('You have already made an appointment for this child and vaccine on the selected date.');
            ...
            // No existing appointment found, proceed to create a new appointment
